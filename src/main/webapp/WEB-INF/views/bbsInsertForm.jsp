		...
		<section id="One" class="wrapper style3">
			<div class="inner">
				<header class="align-center">
					<p style="font-size:25px;">게시글 등록</p>
					<br>   
					<h3>게시글을 등록해주세요</h3>
				</header>
			</div>
				...
				<div style="margin:auto; width:1150px; height:900px;">
					<form action="bbsInsert" id="fr">
						<table class="mytb" style="text-align: center;">
							...
							<tr>
								<td class="mybutton" style="vertical-align:middle;">글내용</td>
								<td align="center">
									<textarea name="editor" id="editor" style="width: 950px; height: 450px;"></textarea>
								</td>
							</tr>
							<tr>
								<td align="left">
								...
								<td align="right">
									<button type="button" class="mybutton" id="bbsInsert"><font size="3" style="color:white;">글 등록</font></button>
								</td>
							</tr> 
						</table>
					</form>
