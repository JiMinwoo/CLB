		...
		<script type="text/javascript">
			$(function(){
				...
				$(document).on("click","#pageDown",function(){
					...
					location.href = "bbsSearch?sc=" + sc + "&pagenum=" + pagenum;
				})
						...
						success : function(data){
							...
							if(data.length>0){
								...
								$(data).each(function(index, bbsList){						
									...
									$("#plz").append("<td align='left'><a href='bbsView?fnum=" + num + "&pagenum=" + pagenum + "'</a>" + title + "</td>");
					...
					<div style="margin:auto; width:1300px; height:900px;">
						...
						<table class="mytb" style="text-align: center;">
							...
							<tbody id="plz">
								...
								<tr> 
									<td>${bbsOne.fnum}</td>
									<td style="text-align: left;"><a href="bbsView?fnum=${bbsOne.fnum}&pagenum=${pagenum}">${bbsOne.ftitle}</a></td>
							...
							<tr>
								<td colspan="5">
									<input type="text" value="${sc}" autocomplete="off" id="sc" placeholder="검색할 글 제목을 입력해주세요">
								</td>
